...
class MainScreen:
    def __init__(self):
        ...
        image = Image.open("images/log.jpg")
        resized = image.resize((1600, 1600), Image.ANTIALIAS)
        ...
        self.btnItem.place(x=700, y=400, width=300, height=45)

        self.btnItem = Button(self.root, text='Bill', command=self.create_bill,
                              font=("Times New Roman", 14, "bold"), fg='white', bg='red')
        self.btnItem.place(x=700, y=500, width=300, height=45)
        ...
        self.mb.place(x=700, y=600, width=300, height=45)

        self.btnExit = Button(self.root, text='Exit', command=self.root.destroy,
                              font=("Times New Roman", 14, "bold"), fg='white', bg='red')
        self.btnExit.place(x=700, y=700, width=300, height=45)
